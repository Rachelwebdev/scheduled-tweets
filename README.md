...
**Scheduled tweets** This project involves building a websited where users can schedule tweets for a particular date and time.
...
- **Users will be able to log in and log out of the webpage.**
- **Users will be able to reset their password.**
- **Users will be able to edit and destroy tweets.**
...
```sh
  cd <desired folder>
  git clone git@github.com:Rachelwebdev/scheduled-tweets.git
```
